...
<body>
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          ...
          <img src="Computer lab.jpeg" style="width:100%">
      ...
      <div class=" table1">
        ...
        <center><h1>Program-wise Time-Table Offline</h1></center>
        <table border="1px">
          <tr>
            <th>Day/Period</th>
          ...
          <tr>
            <td>Monday</td>
            <td>CA301/BCA-1/(Group 1)Malik Ahmed Shahzaad Iqbal (LT-13)</td>
            <td>CA302/BCA-1/Arshad Ali (LT-13)</td>
            <td>CA304/BCA-1/ Nashra Javed(LT-13)</td>
            <td>CA307</td>
            <td rowspan="7"><h1>Lunch breakdown</h1></td>
